//punto 7 se agregan los parametros
class Libro {
    ...
    constructor( titulo , autor , precio, isbn, paginas, idioma, foto, sinopsis) {
      ...
      //punto 8, se asignan los parámetros a las propiedades 
        this.titulo = titulo ;
        this.autor = autor ;
        this.precio = precio;
        this.isbn = isbn;
    ...
    //punto 10, crear el método getHtmlArticle
    getHtmlArticle() {
        return `
          <article>
            <h2>${this.titulo}</h2>
...
//punto 9 se crea el objeto usando el constructor Libro
...
//punto 9 se visualiza con un console.log que esté bien creado
//console.log(libro1);

//punto 11 agregar al contenido de libro1

//let htmlLibro1 = libro1.getHtmlArticle();
